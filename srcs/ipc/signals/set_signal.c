...
/*   Updated: 2025/11/30 21:20:04 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	/* original_signals is t_sig_handler; compare against typed sentinel */
...
{
	/* SIG_IGN is a function-pointer constant; compare directly */
...
{
	/* Block the signal while we modify handlers/state, then install trap */
