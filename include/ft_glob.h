...
/*   Updated: 2025/12/13 00:22:31 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern "C"
{
	...
	{
		/* use the single enum type 't_ast' (was t_ast_t) */
		t_ast_t node_type;
		/* store pointer to token to avoid incomplete-type requirement */
		t_token *token;
		bool has_redirect;
		int redir_idx;
		t_vec children;
	...
	// {// 	static t_gglobe	g = {// 		.noglob_dot_filenames = 1;// 		.glob_always_skip_dot_and_dotdot = 1;// 	};
	// 	return (&g);
	// }
#ifdef __cplusplus
}
