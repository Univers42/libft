...
/// <summary>
/// Para WebServ42. Permite deserializar la posici�n en la cadena a ser validada y el estado actual de los nodos.
/// </summary>
...
/// <summary>
/// Para WebServ42. Permite serializar la posici�n en la cadena a ser validada y el estado actual de los nodos.
/// </summary>
/// <param name="record"></param>
/// <param name="start"></param>
/// <param name="cstate"></param>
