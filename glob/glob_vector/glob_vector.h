...
/* Minimal node type used by the glob_vector helpers.
   The real project may provide a richer definition elsewhere;
   this typedef is sufficient so the API can be declared/used
   without requiring additional headers. */
typedef struct globval
{
	struct globval *next;
	char *name;
} globval;
typedef globval t_list;
