...
int main (void)
{
    ...
    // Notifications
    ft_print_notification("System Update", "All components updated successfully", "success");
    ft_print_notification("Memory Warning", "High memory usage detected", "warning");
    ...
    ft_print_diff("printf(\"Hello World\");", "ft_printf(\"Hello World\");");
    ...
    // Timeline
    char *events[] = {"Project Started", "First Commit", "Tests Added", "Documentation", "Release"};
    char *times[] = {"09:00", "10:30", "14:15", "16:45", "18:00"};
    ft_print_timeline(events, times, 5);
    
    // Typewriter effect
    ft_printf("\n%sTypewriter Effect:%s\n", BOLD, RESET);
    ft_typewriter_effect("This text appears character by character...", 50);
