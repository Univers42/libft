...
#    Updated: 2025/08/15 00:31:59 by syzygy           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_DIRS = ctype debug $(DATA_STRUCTURES) math memory time render stdio stdio/ft_printf/src stdlib strings sort classes/render/inputHandler
