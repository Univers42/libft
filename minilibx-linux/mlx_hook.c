...
/*   Updated: 2025/11/26 15:15:00 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This function sets a callback for a specific
 * X11 event type on the given window.
 * The callback function, its parameter, and the event 
 * mask are stored in the window's hook structure.
 *
 ...
 *
 * This function turns off the auto-repeat feature for keyboard
 * input on the given display context.
 *
 ...
 *
 * This function turns on the auto-repeat feature for keyboard
 * input on the given display context.
 *
 * @param xvar Pointer to the MiniLibX display context.
 * @return Always returns 0.
 ...
 *
 * This function flushes the X11 output buffer and waits until
