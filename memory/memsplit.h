...
/*   Updated: 2025/11/27 15:43:21 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* singleton accessor for the result array:
 * call res_singleton(p) to store p, call res_singleton(NULL) to retrieve current pointer,
 * call res_singleton((t_memsplit_part *)-1) to clear (not used here).
 */
