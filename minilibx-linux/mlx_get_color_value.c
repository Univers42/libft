...
/*   Updated: 2025/11/26 15:11:10 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Converts a given color value to the appropriate pixel
 ...
 * For lower depths, it maps the color to the closest available pixel
 * value using XColor.
 *
 ...
 * This function adapts the input color to the display's color depth and format.
 * For displays with 24 bits or more, it returns the color unchanged.
 * For lower depths, it maps the color to the
 * closest available pixel value using XColor
