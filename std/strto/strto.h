...
{
#ifdef __cplusplus
	/* C++ does not support non-trivial designated initializers like [IDX] = {...}.
	   Provide an ordered initializer that matches the enum order instead. */
	...
	return (gtable);
#else
	/* keep existing C-style designated initializer for C builds */
	static const t_type_info gtable[] = {
