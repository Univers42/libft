...
/*   Updated: 2025/12/19 04:18:05 by dlesieur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//         return (false);
//     c = (t_ast_node *)vec_idx(&word.children, 0);
//     if (!c || !c->token || c->token->type != TOKEN_WORD)
//         return (false);
//     if (c->token->len != 6)
//         return (false);
//     if (ft_strncmp(c->token->start, "export", 6) != 0)
//         return (false);
//     return (true);
// }
...
// {
// 	if (!exp->found_first)
// 		vec_env_push(&ret->pre_assigns, assignment_to_env(exp->curr));
// 	else
// 	{
